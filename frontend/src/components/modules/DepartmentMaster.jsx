...
const DepartmentMaster = () => {
  const [departments, setDepartments] = useState([
    { id: 1, name: 'Engineering', head: 'John Doe', employees: 45, budget: 500000, status: 'Active' },
    { id: 2, name: 'Human Resources', head: 'Jane Smith', employees: 12, budget: 200000, status: 'Active' },
    { id: 3, name: 'Sales', head: 'Bob Johnson', employees: 25, budget: 300000, status: 'Active' },
  ]);
  
  const [newDept, setNewDept] = useState({ name: '', head: '', budget: '', location: '' });
