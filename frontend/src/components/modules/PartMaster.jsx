...
const PartMaster = () => {
  const [parts, setParts] = useState([
    { id: 'P001', name: 'CPU Processor', category: 'Electronics', stock: 150, reorderLevel: 50, price: 299.99 },
    { id: 'P002', name: '16GB RAM Module', category: 'Memory', stock: 85, reorderLevel: 30, price: 89.99 },
    { id: 'P003', name: '1TB SSD', category: 'Storage', stock: 42, reorderLevel: 20, price: 129.99 },
  ]);
  
  const [newPart, setNewPart] = useState({ id: '', name: '', category: '', stock: '', reorderLevel: '', price: '' });

  const handleAddPart = () => {
    if (newPart.id && newPart.name) {
      setParts([...parts, { 
        ...newPart, 
      ...
      setNewPart({ id: '', name: '', category: '', stock: '', reorderLevel: '', price: '' });
    }
  };
